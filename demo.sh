...
python jigsaw_puzzle_solver/assemble_images.py -a demo1 3 3
python jigsaw_puzzle_solver/assemble_images.py -a demo2 2 4
python jigsaw_puzzle_solver/assemble_images.py -a demo3 3 5
python jigsaw_puzzle_solver/assemble_images.py -at demo4 7 6
